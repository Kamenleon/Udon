...
def VGG_like(imput_shape):
        modelVGG = Sequential()

        modelVGG.add(Conv2D(64,(3,3),activation='relu',input_shape=imput_shape))
        modelVGG.add(Conv2D(64,(3,3),activation='relu'))
        modelVGG.add(MaxPooling2D(pool_size=(2,2)))
        

        modelVGG.add(Conv2D(128,(3,3),activation='relu'))
        modelVGG.add(Conv2D(128,(3,3),activation='relu'))
        modelVGG.add(MaxPooling2D(pool_size=(2,2)))

        modelVGG.add(Conv2D(256,(3,3),activation='relu'))
        modelVGG.add(Conv2D(256,(3,3),activation='relu'))
        modelVGG.add(Conv2D(256,(3,3),activation='relu'))
        modelVGG.add(Conv2D(256,(3,3),activation='relu'))
        modelVGG.add(MaxPooling2D(pool_size=(2,2)))
        
        modelVGG.add(Conv2D(512,(3,3),activation='relu'))
        modelVGG.add(Conv2D(512,(3,3),activation='relu'))
        modelVGG.add(Conv2D(512,(3,3),activation='relu'))
        modelVGG.add(Conv2D(512,(3,3),activation='relu'))
        modelVGG.add(MaxPooling2D(pool_size=(2,2)))
        ...
        modelVGG.add(Dense(4096))
        modelVGG.add(Activation('relu'))
        modelVGG.add(Dense(4096))
        modelVGG.add(Activation('relu'))
        modelVGG.add(Dense(4096))
        modelVGG.add(Activation('relu'))
        modelVGG.add(Dense(hp1['class_num'],activation='softmax'))
